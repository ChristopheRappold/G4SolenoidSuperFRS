...
//              pTOF2_log,"pTOF2",experimentalHall_log,false,0);
  ...
  spTOF_log->SetVisAttributes(sTOF_att);
  ...
  //*** CDS ***//
  //***********//
  G4double cds_rmax = CDS_RMAX*mm;
  G4double cds_z    = CDS_Z/2.0*mm;

  G4double cdsPos_x = 0.0*m;
  G4double cdsPos_y = 0.0*m;
  G4double cdsPos_z = 0.0*m;
  ...
  //*** Target-Chamber ***//
  //**********************//
  G4double tarCham_rmax = TARGET_CHM_RMAX*mm;
  G4double tarCham_z = 260.0/2.0*mm;
  G4double tarChamPos_x = 0.0*m;
  G4double tarChamPos_y = 0.0*m;
  G4double tarChamPos_z = 0.0*m;
