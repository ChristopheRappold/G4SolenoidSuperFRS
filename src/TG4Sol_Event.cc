...
/********************************************************************/
TG4Sol_Event::TG4Sol_Event() { Zero(); }
  ...
  for(UInt_t i = 0; i < BeamNames.size(); i++)
    {
      ...
      std::cout << " Particle Mass: " << BeamMasses[i] << "\n";
      std::cout << " Particle Charge: " << BeamCharges[i] << "\n";
      std::cout << " Particle Momentum: (" << BeamMomentums_X[i] << ";";
      ...
      for(UInt_t i = 0; i < DaughterNames.size(); i++)
        {
          ...
          std::cout << " Daughter Mass: " << DaughterMasses[i] << "\n";
          std::cout << " Daughter Charge: " << DaughterCharges[i] << "\n";
          std::cout << " Daughter Momentum: (" << DaughterMomentums_X[i] << ";";
