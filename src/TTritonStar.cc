...
TTritonStar* TTritonStar::Definition()
{
  ...
  if(anInstance == 0)
    {
      anInstance =
          new G4ParticleDefinition(name, mass, width, charge, spin, parity, C_conjugation, Isospin, IsospinZ, G_parity,
                                   pType, lepton_number, baryon_number, encoding, stable, lifetime, NULL, shortlived);
...
/*******************************************************************/
TTritonStar* TTritonStar::TritonStarDefinition() { return Definition(); }

/*******************************************************************/
TTritonStar* TTritonStar::TritonStar() { return Definition(); }
