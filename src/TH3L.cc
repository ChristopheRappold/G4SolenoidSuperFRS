  ...
  if(anInstance == nullptr)
    {
      ...
      G4VDecayChannel* mode_2 =
          new G4PhaseSpaceDecayChannel("H3L", 0.25349, 2, "pi-", "He3"); //"pi-","Z2A3"); //27Oct2012
...
/*******************************************************************/
TH3L* TH3L::H3LDefinition() { return Definition(); }

/*******************************************************************/
TH3L* TH3L::H3L() { return Definition(); }
...
void TH3L::setLT(double LT) { theInstance->SetPDGLifeTime(LT); }
