...
// ********************************************************************
//
// $Id: HypHIPrimaryGeneratorAction.cc 75215 2013-10-29 16:07:06Z gcosmo $
// 
/// \file HypHIPrimaryGeneratorAction.cc
/// \brief Implementation of the HypHIPrimaryGeneratorAction class
...
HypHIPrimaryGeneratorAction::HypHIPrimaryGeneratorAction(const G4SolConfig& conf): G4VUserPrimaryGeneratorAction(),
										   status(0),
...
HypHIPrimaryGeneratorAction::~HypHIPrimaryGeneratorAction()
{
  delete fParticleGun;
}
