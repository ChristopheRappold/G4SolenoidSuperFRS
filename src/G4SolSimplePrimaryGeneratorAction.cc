...
G4SolSimplePrimaryGeneratorAction::G4SolSimplePrimaryGeneratorAction(): G4VUserPrimaryGeneratorAction(),
									fParticleGun(0), fMessenger(0), fPositron(0),
									fMuon(0), fPion(0), fKaon(0), fProton(0),
									fMomentum(1000.*MeV), fSigmaMomentum(50.*MeV), fSigmaAngle(2.*deg),
...
void G4SolSimplePrimaryGeneratorAction::GeneratePrimaries(G4Event* event)
{
